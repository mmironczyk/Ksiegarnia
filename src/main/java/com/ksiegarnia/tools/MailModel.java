    ...
    public boolean sendActivationMail() {
        try {
            ...
            emailBody += "<!DOCTYPE html>\n" +
                    ...
                    "                          <a href=\"\" target=\"_blank\" style=\"display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;\">Aktywuj</a>\n" +
                    "                        </td>\n" +
                    "                      </tr>\n" +
                    "                    </table>\n" +
                    "                  </td>\n" +
