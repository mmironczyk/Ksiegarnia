                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="product-information">
                            <form action="AdminProduct" method="post" enctype="multipart/form-data">
                                ...
                                <label>Gatunek</label>
                                <input type="text" placeholder="Gatunek" name="gatunek" value="${product.model}" class="input-field" id="gatunek"/>
                                <label>Opis</label>
                                ...
                                <input type="text" placeholder="Data wydania" name="data" value="${product.author}" class="input-field" id="data"/>
                                <label>Ilość stron</label>
                                <input type="number" placeholder="Ilość stron" name="pages" value="${product.model}" min="1" class="input-field" id="pages"/>
