...
<div style="margin-top:80px;margin-bottom:280px;">
    ...
    <c:if test="${wynik == true}">
        <a style="font-size: 25px; color:lime">Konto aktywowano pomyślnie!</a>
    </c:if>
        <c:if test="${wynik == false}">
            <a style="font-size: 25px; color:red">Nie udało się aktywować konta!</a>
        </c:if>
